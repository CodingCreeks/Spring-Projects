				...
				<div class="row">
					...
					<div class="col-md-4 col-md-offset-4">
						<div class="form-group">
							<span class="col-md-4"> <small>Profile Completion:<b>
										40%</b></small>
							</span>
							<div class="col-md-6">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="EmploymentInformation">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<label for="inputCurrentSalary"
												class="col-md-2 control-label">Current Salary</label>
											<div class="col-md-2">
											...
											<div class="col-md-4">
												<div class="input-group">
													<input class="form-control" id="inputCurrentSalary"
														placeholder="Curent Salary/Annum" type="text"><span
														class="input-group-addon">per Annum</span>
												</div>
											</div>
											<div class="col-md-4">
												<div class="input-group">
													<input class="form-control" id="inputCurrentSalary"
														placeholder="Curent Salary/Hour" type="text"><span
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<div class="col-md-6">
												<select class="form-control" id="IndustryDomain">
													<option>1--</option>
													<option>2--</option>
													<option>3--</option>
													<option>4--</option>

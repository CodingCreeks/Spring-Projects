...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="PostResume rev-1.jsp">TalentTurbo</a>
		</div>
														...
														<div class="col-md-4">
															<div class="form-group">
																<label for="inputAddress1"
																	class="col-md-4 control-label">Address 1</label>
																<div class="col-md-6">
														...
														<div class="col-md-12">
															<div class="col-md-4">
																<label for="Qualification"
																	class="col-md-4 control-label">Qualification</label>
																<div class="col-md-6">
														...
														<div class="col-md-12">
															<div class="col-md-4">
																...
																<label for="Specialization"
																	class="col-md-4 control-label">Specialization</label>
																<div class="col-md-6">

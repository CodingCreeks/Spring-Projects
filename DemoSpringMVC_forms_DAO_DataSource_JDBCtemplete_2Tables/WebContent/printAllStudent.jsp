		...
		<table align="center" border="1" >
			...
			<c:forEach items="${studentslist}" var="slist">
				<tr>
					...
					<td>&nbsp;<a href="getStudentDataForEdit.do?rollno=${slist.rollno}" title="Edit">
							<img src=<c:url value='images/edit.png'/> width="20" height="20">
					</a>&nbsp; &nbsp;&nbsp;&nbsp;<a href="removeStudent.do?rollno=${slist.rollno}"
						onclick="return confirm('Are you sure?')" title="Delete"> <img
							src="<c:url value='images/del.png'/>" width="20" height="20"></a></td>
				</tr>
			</c:forEach>
		</table>
		<h6 align="right">
